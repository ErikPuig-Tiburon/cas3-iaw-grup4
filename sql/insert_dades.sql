-- INSTITUT MONTSIÀ
-- Fitxer d'inserció manual

USE institut_montsia;

-- Ubicacions (aules i espais del centre)
...
-- TipusMaterial (categories de dispositius)
...
-- Estats (possibles estats d'una incidència)
...
-- Portàtils HP ProBook 450 G8 (aula A101)
...
-- Portàtils HP ProBook 450 G10 (aula A102)
...
-- Portàtils Lenovo ThinkPad L14 (aula A201)
...
-- Portàtils Lenovo ThinkPad L15 (préstec, magatzem)
...
-- ASIX1: portàtils + perifèrics a l'aula A101
...
INSERT INTO Usuaris (nom, cognom1, cognom2, correu, contrasenya_hash, rol, idAlumne, actiu) VALUES
('Professorat', 'CAS3', NULL, 'professor@iesmontsia.org', '$2y$10$abcdefghijklmnopqrstuuiQo633qBvjHafFtT7zjq9sxAnCMbaFi', 'PROFESSOR', NULL, 1),
('Erik', 'CAS3', NULL, 'erik@iesmontsia.org', '$2y$10$abcdefghijklmnopqrstuuiQo633qBvjHafFtT7zjq9sxAnCMbaFi', 'PROFESSOR', NULL, 1),
...
ON DUPLICATE KEY UPDATE
    ...
    cognom2 = VALUES(cognom2),
    contrasenya_hash = VALUES(contrasenya_hash),
    rol = VALUES(rol),
    idAlumne = VALUES(idAlumne),
    actiu = VALUES(actiu);
