...
<section class="grid two" style="margin-top: 1rem;">
    <article class="panel">
        <div class="card">
            <h2 class="section-title">Recompte total per tipus</h2>
        </div>
    ...
    <article class="card">
        <h2 class="section-title">Lectura rapida</h2>
...
<?php foreach ($byClassroom as $aula => $materials): ?>
    <section class="panel" style="margin-top: 1rem;">
        <div class="card">
            <h2 class="section-title">Aula <?= h($aula) ?></h2>
        </div>
        <div class="table-wrap">
            <table>
                <thead>
