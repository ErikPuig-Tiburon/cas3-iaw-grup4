...
<section class="grid two">
    <article class="card">
        <h2 class="section-title">Dades de l'alumne</h2>
    ...
    <article class="card">
        <h2 class="section-title">Assignar material</h2>
...
<section class="panel" style="margin-top: 1rem;">
    <div class="card">
        <h2 class="section-title">Dispositius de l'alumne</h2>
    </div>
...
<section class="panel" style="margin-top: 1rem;">
    <div class="card">
        <h2 class="section-title">Incidencies vinculades</h2>
    </div>
    <div class="table-wrap">
        <table>
            <thead>
